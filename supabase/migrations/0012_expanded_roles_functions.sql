-- =====================================================================
-- NetLog — 0012_expanded_roles_functions.sql
-- Part 2 of the role expansion — run this AFTER 0011_expanded_roles.sql
-- has been run and committed (Postgres won't let a brand-new enum
-- value be used in the same transaction that created it, so this had
